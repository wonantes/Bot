...
__help__ = f"""
Chatbot utilizes the [CoffeeHouse API](https://coffeehouse.intellivoid.net/) and allows Saitama to talk and provides a more interactive group chat experience.
...
*Powered by* [CoffeeHouse from Intellivoid](https://coffeehouse.intellivoid.net/) from @Intellivoid
"""
